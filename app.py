...
def project_data():
    ...
    for post in posts:
        ...
        mlb_season_data["world_series_winner"] = post[10]
        mlb_season_data["runs_scored"] = post[11]
        mlb_season_data["at_bats"] = post[12]
        mlb_season_data["hits"] = post[13]
        mlb_season_data["doubles"] = post[14]
        mlb_season_data["triples"] = post[15]
        ...
        mlb_season_data["strikeouts_by_pitchers"] = post[40]
